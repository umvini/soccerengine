...
//        System.out.println("Red Cards " + away.name + ": " + res.redCardsAwayTeam);
        ...
        PlayingStyle playingStyle = new PlayingStyle().randomPlayingStyle();

        System.out.println("Marking " + playingStyle.getMarking().getDesc());
        System.out.println("Style " + playingStyle.getStyle().getDesc());
    }
}
